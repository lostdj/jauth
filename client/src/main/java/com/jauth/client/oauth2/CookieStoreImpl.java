...
class CookieStoreImpl extends TokenStoreImpl {
  ...
  public native void set(String key, String value) /*-{
    $doc.cookie = @com.jauth.client.oauth2.CookieStoreImpl::COOKIE_PREFIX +
        encodeURIComponent(name) + '=' + encodeURIComponent(value);
  }-*/;

  @Override
  public native String get(String key) /*-{
    var m = @com.jauth.client.oauth2.CookieStoreImpl::ensureCookies();
    return m[@com.jauth.client.oauth2.CookieStoreImpl::COOKIE_PREFIX + key];
  }-*/;

  @Override
  public native void clear() /*-{
    var allCookies = @com.jauth.client.oauth2.CookieStoreImpl::ensureCookies()();
    var prefix = @com.jauth.client.oauth2.CookieStoreImpl::COOKIE_PREFIX;

    for (var key in allCookies) {
      if (key.indexOf(prefix) == 0) {
        this.@com.jauth.client.oauth2.CookieStoreImpl::set(*)(
            key.substring(prefix.length), '');
      }
    }
    @com.jauth.client.oauth2.CookieStoreImpl::cachedCookies = null;
  }-*/;
  ...
  private static native void loadCookies() /*-{
    @com.jauth.client.oauth2.CookieStoreImpl::cachedCookies = {};
    ...
    if (docCookie && docCookie != '') {
      ...
      for ( var i = 0; i < crumbs.length; ++i) {
        ...
        @com.jauth.client.oauth2.CookieStoreImpl::cachedCookies[name] = value;
      }
    }
  }-*/;
